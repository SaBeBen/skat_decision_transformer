...
head = skat_dt_table_data_frame.head(n=10)
print(head)
...
skat_dt_game_data_frame[["CallValueFH", "CallValueMH", "CallValueBH", "PlayerID", "Game",
                         "With", "Without", "Hand", "Schneider", "SchneiderCalled", "Schwarz",
                         "SchwarzCalled", "Overt", "PointsPlayer", "Won", "Miscall",
...
skat_dt_game_data_frame["Game"].value_counts()
...
# Analysis of games
game_variants = skat_dt_game_data_frame["Game"].value_counts(normalize=True)
...
games_won = skat_dt_game_data_frame[skat_dt_game_data_frame["Won"] == 1]
...
games_lost = skat_dt_game_data_frame[skat_dt_game_data_frame["Won"] == 0]
...
plt.savefig("graphics/comp_won_lost_dt.png")
plt.show()
#%%
...
plt.savefig("graphics/won_games_pie_dt.png")
plt.show()
#%%
...
games_clean = skat_dt_game_data_frame.drop(["IDVServer", "StartTime", "EndTime"], axis=1)
