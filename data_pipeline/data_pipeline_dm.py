...
skat_dm_cs_data_path = "C:/Users/sasch/Desktop/Uni/Bachelorarbeit/SaschaBenz/data/dl/dm_skattisch_kf.CSV"

skat_dm_cs_data_frame = pd.read_csv(skat_dm_cs_data_path, header=None)

# TODO: convert data to following encoding:
# ♦, ♥, ♠, ♣, {7, 8, 9, Q, K, 10, A}, J/T
skat_dm_cs_data = skat_dm_cs_data_frame

skat_dm_cs_data.columns = ["GameID", "Sd1", "Sd2", "KNr0", "KNr1", "KNr2", "KNr3", "KNr4", "KNr5", "KNr6", "KNr7",
...
print(skat_dm_cs_data_frame.isna().sum().sum())

#%%

print(skat_dm_cs_data_frame["GameID"].size)

#%%

print(skat_dm_cs_data_frame["GameID"].duplicated().any())

#%%

skat_dm_table_data = skat_dm_cs_data_frame

head = skat_dm_cs_data.head(n=10)
print(head)
...
skat_dm_table_data_path = "C:/Users/sasch/Desktop/Uni/Bachelorarbeit/SaschaBenz/data/dl/dm_skattisch.CSV"

skat_dm_table_data_frame = pd.read_csv(skat_dm_table_data_path, header=None)

skat_dm_table_data_frame.columns = ["IDTable", "Name", "Number", "PlayerID1", "PlayerID2", "PlayerID3", "PlayerID4",
                                    "Player1", "Player2", "Player3", "Player4", "Date", "IDVServer", "Series"]

skat_dm_table_data_frame

#%%

# Sanity Checks

print(skat_dm_table_data_frame.isna().sum())

#%%

print(skat_dm_table_data_frame["IDTable"].size)

#%%

print(skat_dm_table_data_frame["IDTable"].duplicated().any())

#%%

head = skat_dm_table_data_frame.head(n=10)
print(head)
...
head = skat_dm_game_data_frame.head(n=10)
print(head)

#%% Sanity Checks

skat_dm_game_data_frame[["CallValueFH", "CallValueMH", "CallValueBH", "PlayerID", "Game",
                         "With", "Without", "Hand", "Schneider", "SchneiderCalled", "Schwarz",
                         "SchwarzCalled", "Overt", "PointsPlayer", "Won", "Miscall",
...
skat_dm_game_data_frame[["CallValueFH", "CallValueMH", "CallValueBH", "PlayerPosAtTableFH", "PlayerPosAtTableMH",
                         "PlayerPosAtTableBH"]].describe()

#%%

print(skat_dm_game_data_frame.isna().sum().sum())

#%%

print(skat_dm_game_data_frame["GameID"].size)

#%%

print(skat_dm_game_data_frame["GameID"].duplicated().any())

#%%

print(skat_dm_game_data_frame["IDGame"].duplicated().any())

#%%

skat_dm_game_data_frame["Won"].value_counts(normalize=True)

#%%

skat_dm_game_data_frame["Schneider"].value_counts(normalize=True)

#%%

skat_dm_game_data_frame["Schwarz"].value_counts(normalize=True)

#%%

skat_dm_game_data_frame["Game"].value_counts()

#%%

skat_dm_game_data_frame["AllPassed"].value_counts(normalize=True)

#%%

skat_dm_game_data_frame["Miscall"].value_counts(normalize=True)

#%%

skat_dm_game_data_frame["Surrendered"].value_counts(normalize=True)
...
# Analysis of games
game_variants = skat_dm_game_data_frame["Game"].value_counts(normalize=True)
...
plt.savefig("graphics/all_games_pie_dm.png")
plt.show()

#%%

# Filter the games that were won
games_won = skat_dm_game_data_frame[skat_dm_game_data_frame["Won"] == 1]
...
games_lost = skat_dm_game_data_frame[skat_dm_game_data_frame["Won"] == 0]
...
plt.savefig("graphics/comp_won_lost_dm.png")
plt.show()
#%%
...
plt.savefig("graphics/won_games_pie_dm.png")
plt.show()
...
games_clean = skat_dm_game_data_frame.drop(["IDVServer", "StartTime", "EndTime"], axis=1)
